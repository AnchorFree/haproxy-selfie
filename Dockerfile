...
ENV HAPROXY_METRICS_REFRESH_INTERVAL 5
...
RUN apk add --no-cache lua5.3-ossl ca-certificates openssl && mkdir -p /etc/haproxy/system /etc/haproxy/user /etc/haproxy/conf /etc/haproxy/lualibs
